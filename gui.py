        ...
        match selected_option:
            ...
            case 'compress':
                ...
                def reduce_file_size(file, out_file):
                    result = self.funcs.compress(file, out_file)
                    frame.pack_forget()
                    frame2 = tk.Frame(self)
            ...
            case 'convert_images_to_pdf':
                ...
                def convert_images_to_pdf(list_of_images: list, output_pdf: str):
                    ...
                    result_info = tk.Label(self, text=result)
                    go_to_homepage = tk.Button(self, text='Back to homepage', command=lambda: (list_of_files_instructions.pack_forget(), result_info.pack_forget(), title.pack_forget(), self.window()))
                    result_info.pack()
                    go_to_homepage.pack()
                ...
                back_to_homepage = tk.Button(frame, text='Back to homepage', command=lambda: (title.pack_forget(), list_of_files_instructions.pack_forget(), frame.pack_forget(), self.window()))
            ...
            case 'watermark':
                ...
                back_to_homepage = tk.Button(frame, text='Back to HomePage', command=lambda: (indicies_instructions.pack_forget(), title.pack_forget(), frame.pack_forget(), self.window()))
